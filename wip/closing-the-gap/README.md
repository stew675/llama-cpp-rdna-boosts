...
> **Current set (2026-09-24, session 9): the campaign is now 28 patches** (`0001..0014` +
> `0016..0029`, still skipping `0015`).  `0027` = the meta-backend `graph_optimize` forwarding;
...
> [`2026-09-24-mtp-cpu-spin-automatic.md`](2026-09-24-mtp-cpu-spin-automatic.md).  A fresh r13+beta
> worktree + all 28 in order (`for p in .../patches/0*.patch; do` skip `0015`, `git am "$p"`; `done`)
> applies **28/28** and reproduces tree `fa9cf6d1e654333d458ade3655c4a0d540225827`.
