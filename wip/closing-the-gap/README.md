...
| [`gfx1201-closing.md`](gfx1201-closing.md) | **hand-off brief for the gfx1201 (3× R9700) box:** apply the full r13 + `beta/mmb-general` + `wip/closing-the-gap` stack, then validate/port every arch-sensitive piece on RDNA4 (it can run qwen4exp).  Arch-scoped inventory, gates, expected `MMB_CFG` row, port candidates, traps. |
