...
Q8T2_EXTRA = ["-sm", "tensor"]
Q8T2 = [("reasoning", "r1-reasoning.txt"), ("prose", "p1-prose.txt"),
        ("code", "c1-code.txt"), ("recall", "k1-recall.txt")]

print("=== 3-GPU (0,1,2) tensor Q8_0: base vs ref_d (ratio ref_d/base) ===")
print(f"{'prompt':20s} {'base':>8s} {'ref_d':>8s} {'ratio':>7s}")
for axis, fname in Q8T2:
    b = run("q3_base", D8, "0,1,2", Q8T2_EXTRA, axis, fname, {})
    d = run("q3_refd", D8, "0,1,2", Q8T2_EXTRA, axis, fname, REFD)
