...
| `~/llama.cpp` (fork) | **`packed-qsa`** (off `rdna-boosts`) | `4f464941a` = **P3 part 2** (packed WMMA kernel) on `91f5e41a0` = **P3 part 1** (WMMA primitive) on `1697ad10e` = **P2** on `2b84c7c62` = **P1** on `b214621da` = the tiled-GDN spike |
...
2. `P1-NOTES.md` / `P2-NOTES.md` / `P3-DESIGN.md` / `P3-NOTES.md` (this tree) — the P1-P3 records.
