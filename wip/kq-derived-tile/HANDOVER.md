...
Perf A/B harness (writes `tag,depth,derived,pp512,tg128`): `wip/kq-mask-derived-ab/data/kq-ab.sh`.
...
| 5 | build-time growth in 96 instances | the r6 work was about exactly this | measure `ggml-hip -j16` before/after (`wip/build-time-regression/`) |
