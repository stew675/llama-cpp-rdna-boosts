...
`wip/prefill-arrangements/README.md` (that doc covers the qwen4exp/QSA/`mmb` arrangement family; this
one covers the **dense uniform-Q8_0** case).

> **Session handover:** `wip/q8-prefill-tuning/HANDOVER.md` — self-contained brief with the design,
...
`wip/q8-prefill-tuning/OVERLAP-DESIGN.md`.
...
6. Lower-priority tail (from the ub2048 trace): `quantize_mmq_q8_1` (3.7 %), the `convert_unary`
   ...
   `wip/prefill-arrangements/README.md` §2a.
