...
| **block 15 (r4 candidate)** — mixed-K/V kernel contract fix + `get_alloc_size` q4_0 fix + the prefill band split + the arena + the RDNA3_5 arch gate | **VALIDATED on gfx1201+gfx1151, NOT promoted** | `wip/issue-30-mtp-decode-regression/patches/2026-09-14-todo21-prefill-arena-staging.diff` (7 files, 352 lines) |
...
One diff: **`wip/issue-30-mtp-decode-regression/patches/2026-09-14-todo21-prefill-arena-staging.diff`**
...
git apply ~/llama-cpp-rdna-boosts/wip/issue-30-mtp-decode-regression/patches/2026-09-14-todo21-prefill-arena-staging.diff
...
## 5. File inventory (all under `wip/issue-30-mtp-decode-regression/` unless noted)
...
* Raw logs: `/home/stew675/wip-issue30/results/2026-09-14-todo21-*.txt` (perf/purity/text),
  ...
  `todo21-*` set are in `wip/issue-30-mtp-decode-regression/results/`.
