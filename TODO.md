...
- **Fork/canonical state**: the working checkout's `rdna-boosts` is a local rebuild and must NOT be used
  ...
  block-14 commit `27bd754b6` (rebuilt at `9113cc188`; block 02 amended 2026-09-11 with the opt-in
  `GGML_CUDA_GDN_ALIGN_BOUNDARY` boundary); `make-patches.sh` default tip = `27bd754b6`.
