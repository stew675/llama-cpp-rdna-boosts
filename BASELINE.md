...
`1bcf4e82d`; block 02 amended 2026-09-11 with the
...
`1bcf4e82d` refers to).  The two commits' content is 106 lines in 3 files
...
the current 15-block tip `1bcf4e82d`), then re-verify the clean-apply
