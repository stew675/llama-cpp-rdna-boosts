...
`5ad11fd35`; block 02 amended 2026-09-11 with the
...
`5ad11fd35` refers to).  The two commits' content is 106 lines in 3 files
...
the current 15-block tip `5ad11fd35`), then re-verify the clean-apply
