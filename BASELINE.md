...
`389c5341f`; block 02 amended 2026-09-11 with the
...
`389c5341f` refers to).  The two commits' content is 106 lines in 3 files
...
the current 15-block tip `389c5341f`), then re-verify the clean-apply
