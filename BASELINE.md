...
`27bd754b6`; block 02 amended 2026-09-11 with the opt-in
`GGML_CUDA_GDN_ALIGN_BOUNDARY` K-independent boundary, and block 13 amended
...
`27bd754b6` refers to).  The two commits' content is 106 lines in 3 files
...
is removed; tip `27bd754b6`; block 02 amended 2026-09-11 with the opt-in
`GGML_CUDA_GDN_ALIGN_BOUNDARY` K-independent boundary and block 13 amended
...
the current 15-block tip `27bd754b6`), then re-verify the clean-apply
