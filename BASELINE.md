...
`6f07fe67a`; block 02 amended 2026-09-11 with the
...
`6f07fe67a` refers to).  The two commits' content is 106 lines in 3 files
...
the current 15-block tip `6f07fe67a`), then re-verify the clean-apply
