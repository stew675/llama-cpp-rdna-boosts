...
`1d8f53594`; block 02 amended 2026-09-11 with the
...
`1d8f53594` refers to).  The two commits' content is 106 lines in 3 files
...
the current 15-block tip `1d8f53594`), then re-verify the clean-apply
