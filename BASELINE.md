...
`bfaa83d8a`; block 02 amended 2026-09-11 with the
...
`bfaa83d8a` refers to).  The two commits' content is 106 lines in 3 files
...
the current 15-block tip `bfaa83d8a`), then re-verify the clean-apply
