...
`archive/work/mtp-journey-2026-09-17/corpus/`, 4 per axis, hash-frozen (`MANIFEST.md`): reasoning `r1`-`r4`
...
All under `archive/work/mtp-journey-2026-09-17/` (untracked, unpushed).  `README.md` = the full narrative;
...
* `git status` = only `?? archive/work/mtp-journey-2026-09-17/`.
