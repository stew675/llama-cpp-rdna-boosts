...
CANDS = {
 "climbonly": {"GGML_MTP_CLIMB_BASE": "10", "GGML_MTP_CLIMB_SLOPE": "3"},
 "drop120":   {"GGML_MTP_DROP_FLOOR": "120", "GGML_MTP_DROP_SLOPE": "20"},
 "climb12":   {"GGML_MTP_CLIMB_BASE": "12", "GGML_MTP_CLIMB_SLOPE": "4"},
}
