...
> validated 2026-09-06 — `archive/work/wip-archive/qwen4exp/discovery/2026-09-06-gfx1201-rdna4-routed-moe-mmq.md`:
...
- [x] **0.1** Write the soar bench/coherence runner (reuse `/tmp/ab-run.sh` pattern; keep it
      under `archive/work/qwen4exp/gfx1201/` so it survives reboots): VRAM-plateau load detection,
      hang detection (one-GPU-100% + host-100%), pkill bracket pattern, logs to a dated dir.
      → `archive/work/qwen4exp/gfx1201/bench-run.sh` (watcher + timeout 900 + bracket pkill + dated
      log dir under `runs/`).
- [x] **0.2** Full pre-port baseline table on the fixed build — DONE 2026-09-06 (soar, 3x
      ...
      multi-ubatch pipelining.  Raw logs: `archive/work/qwen4exp/gfx1201/runs/p0-*.log`.
- [x] **0.3** Coherence fingerprint gfx1201 vs gfx1151 canonical — DONE 2026-09-06 (bf16 KV,
      ...
      `archive/work/qwen4exp/gfx1201/runs/coh-*` + halo `/tmp/halo-ab/coh-bf16-halo.txt`.
- [x] **0.4** Record the baseline — this worklog entry + raw logs under
      `archive/work/qwen4exp/gfx1201/runs/` (2026-09-06).
...
- [x] **1.1 Routed-compact MoE MMQ** (beta patch 5 / `mul_mat_q_routed_compact` +
      ...
      `archive/work/wip-archive/qwen4exp/discovery/2026-09-06-gfx1201-rdna4-routed-moe-mmq.md`.
...
- [x] **2.1** Depth-0 ladder + tg (tensor AND layer split) on the fixed build, IQ4_XS + MTP
      ...
      **CORRECTION (2026-09-12, do not reuse the "prefill crossover" line above as evidence):**
      ...
      `archive/work/wip-archive/qwen4exp/discovery/2026-09-07-qsa-dense-crossover-tables-soar-halo.md` ("**Soar:
...
- Harness: `archive/work/qwen4exp/gfx1201/bench-run.sh` (watcher + hang-safe timeout + dated logs).
...
- Record: `archive/work/wip-archive/qwen4exp/discovery/2026-09-06-gfx1201-rdna4-routed-moe-mmq.md`.
...
- QSA_OFF depth ladder (interleaved r1, tensor bf16):
  ...
  a Phase-5-style package; record `archive/work/wip-archive/qwen4exp/discovery/2026-09-06-gfx1201-qsa-depth.md`.
...
`archive/work/wip-archive/qwen4exp/discovery/2026-09-06-gfx1201-qsa-depth.md`.  Also untested: 2.0.2
...
RCCL_BUFFSIZE=16777216`; UNPINNED; harness `archive/work/qwen4exp/gfx1201/bench-run.sh`; box drifts
...
- Halo regime data landed (`archive/work/wip-archive/qwen4exp/discovery/2026-09-07-halo-gfx1151-dense-vs-qsa-regime.md`):
...
- Record: `archive/work/wip-archive/qwen4exp/discovery/2026-09-07-halo-gfx1151-fused-AB.md`.  Fused build
...
- [3] (derived block-vector cache, fork 328ddfa4e + 6703ad09f) parked as a wash: provably active
  ...
  guard fix + capped fill stay.  Record: `archive/work/wip-archive/qwen4exp/discovery/2026-09-07-sparse-decode-cost-isolation-rocprof.md`.
...
- Record: archive/work/wip-archive/qwen4exp/discovery/2026-09-07-qsa-dense-crossover-tables-soar-halo.md.
...
- ARCHIVED from the fork (patches + README in archive/work/wip-archive/qwen4exp/patches/2026-09-07-
