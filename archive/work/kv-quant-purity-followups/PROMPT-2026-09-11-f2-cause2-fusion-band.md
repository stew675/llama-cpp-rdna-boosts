...
1. `archive/work/kv-quant-purity-followups/README.md` — **the F2 cause-2 section** (the census table, the
...
* Delivery repo `~/llama-cpp-rdna-boosts`, `main` = **`e7a0a1c`** (pushed).  Block-15 beta: tip
  **`0c8099ca2`** (tree `7335b923d`, base `1bcf4e82d`), patch in
  `archive/work/block-15-campaign-wins/block-15-campaign-wins.patch`.
...
* Probe: `archive/work/kv-quant-purity-followups/tools/logits-dump-kv.cpp` ->
