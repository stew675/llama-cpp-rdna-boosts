...
5. **8th block-15 beta re-cut**: `git am -3` the beta patch on the new tip, resolve, squash, re-export
   ...
   `archive/work/block-15-campaign-wins/block-15-campaign-wins.patch`, and **round-trip it** (apply the
...
6. Docs sweep (newest-first, never rewrite a dated record): a new `WORKLOG.md` entry; the block-08 and
   ...
   `archive/work/kv-quant-purity-followups/README.md` table row; and the `tools/` scripts if you add any.
