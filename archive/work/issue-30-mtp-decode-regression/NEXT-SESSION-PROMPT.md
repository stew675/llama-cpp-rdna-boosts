...
`archive/work/issue-30-mtp-decode-regression/README.md`, `MEASUREMENTS.md` §B (the V4 prefill table) and §D (the
...
`a2c8d06a7`; save the diff under `archive/work/issue-30-mtp-decode-regression/patches/` before proposing promotion
...
`archive/work/issue-30-mtp-decode-regression/tools/` (`bench_mtp.py`, `depth_sweep.sh`, `run_depth_audit.sh`,
