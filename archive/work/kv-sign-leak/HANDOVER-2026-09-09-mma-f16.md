...
`~/llama-cpp-rdna-boosts/archive/work/strix-halo/kvzero/RECORD-2026-09-09.md` (298 lines:
protocols, matrices, mechanism note, gotchas). Patches:
`archive/work/kv-sign-leak/0001-*.patch` (Vulkan), `0002-*.patch` (HIP TILE bf16),
...
- Probe/dump/diag binaries in `archive/work/strix-halo/kvzero/`; fattn-probe.cpp now
