# Strix Halo session brief s7 — final campaign handoff (2026-09-06)

ARCHIVE NOTE (2026-09-06): the dated Strix records moved from benchmarks/ + the older briefs
to archive/work/wip-archive/qwen4exp/discovery/; the 21-patch beta series was folded into the amended
top-level blocks (0002/0004/0008/0013) + ONE beta/qwen4exp/qwen4exp-support.patch. Trail +
fold map: archive/work/wip-archive/qwen4exp/README.md. Delivery verified from-scratch 2026-09-06:
8b4b3558f + blocks(amended) + qwen4exp-support.patch == fork f5ac11903 (0-diff).
...
Delivery 17 patches verified -> b987877d7 (tip); records: 2026-09-06 (mmq defect), 2026-09-06
...
- ~/llama.cpp (qwen4exp) tip `b987877d7` - 0a3a2b498 (quantize chunk) then b987877d7 (repeat-
  ...
  history was SQUASHED 2026-09-06 - opt-in commit no longer exists) -> b31940a5e (weighted-down
...
## THE 2026-09-06 FIND (record: archive/work/wip-archive/qwen4exp/discovery/2026-09-06-strix-halo-gfx1151-mmq-j128-latent-defect.md)
...
## Depth-0 state (same-session A/B, t/s, higher=better; 2026-09-06 measurements)
...
5. Re-verify the full patch series from-scratch when the next fork commit lands (series = 13 amended top-level blocks + 1 beta patch, delivery tip 0044cfe, reproduced f5ac11903
   0-diff 2026-09-06 from 8b4b3558f (see archive/work/wip-archive/qwen4exp/README.md for the fold trail)).
...
verified 2026-09-06). ROCm: /opt/rocm-7.14-gfx1151, gfx1151, wave32, 40 CU, WMMA available
