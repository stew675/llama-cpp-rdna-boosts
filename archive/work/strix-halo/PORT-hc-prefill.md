...
- Files copied (from B c7af5c6c2, VERBATIM): 
  ...
  (originals also saved in archive/work/strix-halo/port-ref/).
...
1. SPLICE into ~/llama.cpp/ggml/src/ggml-cuda/ggml-cuda.cu:
   ...
   b. Copy B's `ggml_cuda_match_hc_mix(...)` (B ggml-cuda.cu ~line 3529,
      saved at archive/work/strix-halo/port-ref/B-match-hcmix.txt, starts at its
...
7. RECORD: dated bench file archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-*.md + notes
