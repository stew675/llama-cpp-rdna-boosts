...
(`archive/work/strix-halo/issue25/GATE-2026-09-11-block00-rdna35.md` §5,
`archive/work/strix-halo/issue25/RECORD-2026-09-11-issue25.md` §5.1).
...
```sh
# probe (archive/work/kv-quant-purity-followups/tools/logits-dump-kv.cpp), 4B/1-GPU style
...
(`archive/work/strix-halo/issue25/logits-width.cpp`) measures `max|W1-W3|` / `max|W3-W5|`
