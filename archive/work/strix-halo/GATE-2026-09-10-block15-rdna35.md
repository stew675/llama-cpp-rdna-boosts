...
> `WORKLOG.md`, `archive/work/block-15-campaign-wins/`.  This file is the complete
...
> `archive/work/block-15-campaign-wins/block-15-campaign-wins.patch` and is applied
...
* W4 repro (`archive/work/arch-independent-memory/repro/ggml-alloc-unused-view.c`):
