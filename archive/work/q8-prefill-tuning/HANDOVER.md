...
**Unlanded.**  Everything in `archive/work/q8-prefill-tuning/` (this file, `OVERLAP-DESIGN.md`, `README.md`,
...
```bash
git apply <repo>/archive/work/q8-prefill-tuning/tools/ce-allreduce.patch        # ce + GGML_AR_NOOP + stream hook
git apply <repo>/archive/work/q8-prefill-tuning/tools/meta-chunk-pipeline.patch # ggml-backend.h + meta backend
...
archive/work/q8-prefill-tuning/tools/ce-allreduce.patch        # ce + GGML_AR_NOOP + the stream hook
archive/work/q8-prefill-tuning/tools/meta-chunk-pipeline.patch # ggml-backend.h + ggml-backend-meta.cpp
...
`archive/work/q8-prefill-tuning/OVERLAP-DESIGN.md` — read that before starting.**
...
## 6. Tools index (`archive/work/q8-prefill-tuning/tools/`)
...
5. Wrote `archive/work/q8-prefill-tuning/OVERLAP-DESIGN.md` (the design + change sites + risks + validation +
