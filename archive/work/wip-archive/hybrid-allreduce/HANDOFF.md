...
- **Fixed a silent-corruption bug in phase 3** (whole-vector accumulation)
  ...
  isolated by `archive/work/tools/ar_kernel_unit.cpp` (unit test of the extracted
...
HIP_VISIBLE_DEVICES=1,2 ~/llama-cpp-rdna-boosts/archive/work/tools/ar_signal_bench (build first)
...
- `archive/work/tools/` — standalone benchs (ar_signal_bench, rccl_ar_bench, probes)
