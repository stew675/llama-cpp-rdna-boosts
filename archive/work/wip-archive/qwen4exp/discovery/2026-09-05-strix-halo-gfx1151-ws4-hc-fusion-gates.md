...
- The logit-level bit-exactness evidence (llama_decode harness, pp + 40
  ...
  `archive/work/strix-halo/notes-ws1-survey.md` (2026-09-06 LATE entry).
...
- Follow-ons (same 2026-09-06 session / 2026-09-05): re-derive the
  ...
  RDNA4-gated) — see `archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-post-fusion-gap.md`.
