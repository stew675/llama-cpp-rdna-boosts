...
CONTINUE from this file + ~/make-strix-halo-faster.md + archive/work/strix-halo/notes-ws1-survey.md +
...
- `archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-ws3-shortcut-artifact-rootcause.md` — ROOT CAUSE of
  the WS3 #2 llama-bench artifact + same-session tradeoff numbers (the fix task's evidence base).
- `archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-ws3-routed-moe-mmq.md` — WS3 #3 gates + A-vs-B gap.
- `archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-post-fusion-gap.md` — post-WS4 gap + WS3 #2 section.
- `archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-ws4-hc-fusion-gates.md` — WS4 gates.
- `archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-block-13-moe-mmq.md` (+ the gfx1100 twin) — block 13.
...
- Parked: LFRU host->GPU slow hot-weight migration (archive/work/qwen4exp/LRU_EXPERTS.md,
...
records in benchmarks/YYYY-MM-DD-strix-halo-*.md; scratch in archive/work/strix-halo/ + /tmp/gateA/.
