...
trail (archive/work/strix-halo/notes-ws1-survey.md). Read all three first.
...
- ~/llama-cpp-rdna-boosts: tip 4d54c74 (archive/work/strix-halo notes committed).
  archive/work/strix-halo/ = experimental notes only, NOT delivery.
...
2. Dated bench record archive/work/wip-archive/qwen4exp/discovery/2026-09-06-strix-halo-*.md (mirror the
