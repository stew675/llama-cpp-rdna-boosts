...
evidence trail (archive/work/strix-halo/notes-ws1-survey.md) + the two 2026-09-06
...
- ~/llama-cpp-rdna-boosts (delivery), tip `dff3a9a` (this session's
  ...
  archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-ws4-hc-fusion-gates.md and
...
2. **Post-fusion A-vs-B depth-0 gap re-derived** (record:
   archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-post-fusion-gap.md), A
