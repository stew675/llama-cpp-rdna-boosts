...
trail (archive/work/strix-halo/notes-ws1-survey.md) + the dated records (below). Read all
first.
...
1. **WS3 #3 (routed-compact MoE MMQ for the i-quants) DONE, DEFAULT ON**
   (record: archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-ws3-routed-moe-mmq.md):
...
1. **WS3 #2 llama-bench artifact — ROOT CAUSE FOUND (2026-09-05), no code
   ...
   archive/work/wip-archive/qwen4exp/discovery/2026-09-05-strix-halo-gfx1151-ws3-shortcut-artifact-rootcause.md.
