...
`archive/work/wip-archive/qwen35moe-prefill/decode-phase1-results.md` + `plan-decode.md`.
...
archive/work/qwen4exp/patches/0009-hc-mix-fused-decode-op.patch (+ 0009-*.md), apply-
...
- Boost repo main @ 94a3474: archive/work/qwen4exp/patches/0009-*.patch + .md.
...
- Patch blocks 0009-0014 in archive/work/qwen4exp/patches/ (0009 + 0010 = the two
