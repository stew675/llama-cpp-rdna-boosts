...
Supporting records: `archive/work/wip-archive/qwen4exp/discovery/2026-09-07-sparse-decode-cost-isolation-rocprof.md`
and the worklog entries in `archive/work/qwen4exp/gfx1201-porting.md` (the launch-cut A/Bs, the
