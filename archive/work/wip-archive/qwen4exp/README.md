...
- `discovery/` — the dated Strix Halo investigation records + older session briefs moved
  out of `benchmarks/` and `archive/work/strix-halo/` (kept: methodology/gate docs in `benchmarks/`,
  the current `archive/work/strix-halo/SESSION-BRIEF-2026-09-06.md`, `TODO.md`).
