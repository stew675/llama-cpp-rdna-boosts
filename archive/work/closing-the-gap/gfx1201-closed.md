# gfx1201 — closing-the-gap: **closed items archive** (pre-split snapshot)

**This file is the completed-work history for the gfx1201 (3× R9700) box — the append-only record of what
was validated, ported and measured.**  It was split out of the old `gfx1201-closing.md` on 2026-09-24 so
the brief for a fresh session stays short.

> **The live brief is [`gfx1201-closing.md`](gfx1201-closing.md).**  That file carries the remaining
> open items and the operational instructions.  Every closed item below is referenced from it with a
> one-line verdict.  **Sections §12.4 and §13 are OPEN at the time of this snapshot** — they are kept
> here only as history and are superseded by `gfx1201-closing.md` §2 (§12.4 → OP-5, §13 → OP-1).  Do
> not start new work from this file.
>
> Everything else (the session log §11, the gate results, the per-patch verdict table §7, the DONE
> work items §12.1-§12.3, the lossy-prefill transfer, the `0016` port and the closed §13.7 cliff fix)
> is the authoritative detail for **closed** work and is safe to cite.

**Companion files:** [`gfx1201-closing.md`](gfx1201-closing.md) (live open work),
[`gfx1151-closing.md`](gfx1151-closing.md), [`gfx1100-closing.md`](gfx1100-closing.md),
[`closing-the-gap.md`](closing-the-gap.md), [`README.md`](README.md).
...
> **Historical snapshot (pre-split).**  The live open-item brief is [`gfx1201-closing.md`](gfx1201-closing.md).
...
> **Historical apply flow.**  The live, current apply flow (27-patch closing set) is
> [`gfx1201-closing.md`](gfx1201-closing.md) §3.2.  The block below is the original 25-patch flow and is
...
### 4a. Closing patches (`archive/work/closing-the-gap/patches/`)
...
> **⚠️ OPEN — moved to [`gfx1201-closing.md`](gfx1201-closing.md) §2.5 (OP-5).**  Kept here only as
...
> **⚠️ OPEN — moved to [`gfx1201-closing.md`](gfx1201-closing.md) §2.1 (OP-1).**  This is the original
> instruction set; the live file carries the updated reproduction and the same candidates.  §13.7 (the
> W=9 cliff) is **closed** and its detail is the session-8 entry in §11 above.
