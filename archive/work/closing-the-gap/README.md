...
[`../../beta/mmb-general/`](../../beta/mmb-general/) on 2026-09-25** (28-patch set, r13-based,
...
* **Current (end of session 12):** `~/llama.cpp` branch **`gap-closing-hostbuf-integrated`** @
  **`df67fd133`** = delivery r13 + the 12 `beta/mmb-general/patches/*.patch` + gap-closing
