...
`archive/work/tiled-gdn/05-where-the-speed-comes-from.md` and the archived
...
- On gfx1201 the delivery's chunked bf16 GDN is **~5x faster than pwilkin's tiled GDN** at the op
  level (see `archive/work/tiled-gdn/03-validation-gfx1201.md`), so there is no GDN-side arrangement gap of
  the `qsa3` scale.
