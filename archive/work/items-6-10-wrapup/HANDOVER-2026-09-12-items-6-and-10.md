...
> 35B-A3B, tg flat).  See `archive/work/qwen4exp/gfx1201-porting.md` (2026-09-12 entry) and TODO item 6.

**Read this file first; it is self-contained.**  Shared environment/instrument rules live in
`archive/work/kv-quant-purity-followups/HANDOVER-2026-09-11-remaining-work.md` §2–§5/§12/§13 and in
...
(`archive/work/wip-archive/qwen4exp/discovery/2026-09-06-gfx1201-rdna4-routed-moe-mmq.md`: ub2048 tensor-split
...
3. If the claim does **not** hold (a divergence appears), that is a *finding*: stop, root-cause it (the
   ...
   `archive/work/qwen4exp/gfx1201-porting.md` (+ the TODO item-6 wording, + a `benchmarks/` record if the numbers
...
* **Beta:** the Block 15 patch is the **10th re-cut** — base `484231cb9` → beta tip `a796a1d49`, tree
  ...
  `archive/work/block-15-campaign-wins/block-15-campaign-wins.patch`.  It builds (`/tmp/blk15y/build-rec10`)
...
* **Instruments:** `archive/work/kv-quant-purity-followups/tools/` — `qperf.sh` (parameterised perf table),
...
cd /tmp/canon-llama && git worktree add -f -q /tmp/blk15z $NEW && cd /tmp/blk15z && \
  ...
  git am -3 /home/stew675/llama-cpp-rdna-boosts/archive/work/block-15-campaign-wins/block-15-campaign-wins.patch
...
cp /tmp/b15-11.patch /home/stew675/llama-cpp-rdna-boosts/archive/work/block-15-campaign-wins/block-15-campaign-wins.patch
...
dated entry appended to `archive/work/qwen4exp/gfx1201-porting.md`.  Commit + push **only** to the delivery
repo's `origin`.
