...
on `9113cc188` uses the canonical 15-block tip `bfaa83d8a` (block 02 amended twice 2026-09-11 — the
...
the dated records below; regenerated tip `bfaa83d8a`, blocks' bodies
...
current delivery is the 15-patch set `0000`-`0014`, tip `bfaa83d8a`):
