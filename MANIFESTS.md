...
on `9113cc188` uses the canonical 15-block tip `389c5341f` (block 02 amended twice 2026-09-11 — the
...
the dated records below; regenerated tip `389c5341f`, blocks' bodies
...
current delivery is the 15-patch set `0000`-`0014`, tip `389c5341f`):
