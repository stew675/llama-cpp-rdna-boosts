...
fork's `rdna-boosts` block commits).  **Current regeneration (2026-09-12 (13))**: canonical 15-block tip **`d306d4b4b194738dd5baad89ef77fa31a931e8ff`** (net tree `3b0874b6aa367fea846a437b45f1689bd173b38c`), clean-apply strict 15/15 with 0 whitespace warnings and the applied tree equal to the canonical one.  Block **14**'s body changed in this regeneration (its 2026-09-12 (eighth) amendment: the QSA indexer-score decode/verify band-uniformity fix; block 14 is the tip, so no blocks were replayed), and patch bodies `0000`-`0013` are byte-identical to the previous regeneration.  **The beta block-15 patch was re-cut (17th) on this base**: tip `f399b13494df50d44450b0a3960eb55f6952335b`, tree `c3142fe0b311757f458647f172f623859f5bc983`, strict `git am` round-trip.  The previous regeneration was 2026-09-12 (12) (tip `c6f1e8e78`, block 14's MTP-export logits-purity fix).  The regeneration
