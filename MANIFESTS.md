...
on `9113cc188` uses the canonical 15-block tip `33ccf7e28` (block 02 and block 13 amended 2026-09-11), because the reference `~/llama.cpp` checkout had drifted
...
the dated records below; regenerated tip `33ccf7e28`, blocks' bodies
...
current delivery is the 15-patch set `0000`-`0014`, tip `33ccf7e28`):
