...
bit-identical at nt == 1) plus the 28-patch `beta/mmb-general` re-base onto r3 then r4 (r4 applied tree
`70cc895a…`, r3 `0daefe22…`) and its gfx1100 routed-band fix (patch 0027: the 16-wide `mul_mat_vec_q_moe` band is now
