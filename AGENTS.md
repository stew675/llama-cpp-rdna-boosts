...
(tip `3d27ae995f44b53cdcb9f9559cb785367bbe57c2`, net tree
  ...
  per-device tensor path - block 15 because it is the last block touching `ggml-backend-meta.cpp`).
