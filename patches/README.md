...
**Current release: `v16-84e76d8a2-r5`** — canonical (rebased) tip
`62eaaec3e41bbefeda2f3625ecd6e6f7e814e2f0`, tree
`de86c5e11f8dbebedec42be16c00cda7f68853a2`.  Strict 16/16 `git am`; clean build.  **r5
...
flat.  The bf16 native default is left opt-in (its prefill trade is unchanged).
